...
public class PullToRefreshListViewFooter extends LinearLayout {
	...
	public void setState(int state) {
		if (state == STATE_NORMAL) {// Ê≠£Â∏∏Êó∂Â?ÔºåÈöêËóèfoor
	...
	private void initView(Context context) {
		mContext = context;
		RelativeLayout moreView = (RelativeLayout) LayoutInflater.from(mContext).inflate(R.layout.app_pull_listview_footer, null);
		addView(moreView);
